...
# This Lambda function should be deployed before the API stack, or the CustomResource creation will hang up
...
def encrypt_cloud_formation_input(event, context):
